...
import { unitImportSchema, type UnitImportFormData } from "../schemas"
import { UnitsImportPreviewDialog } from "./units-import-preview-dialog"
      ...
      <ResponsiveDialog open={open} onOpenChange={handleOpenChange}>
        <ResponsiveDialogContent className="sm:max-w-md">
          <ResponsiveDialogHeader className="text-start">
            ...
            <ResponsiveDialogDescription>
              Bulk create units by uploading a CSV file.
            </ResponsiveDialogDescription>
          </ResponsiveDialogHeader>
            ...
            >
              ...
              <FieldGroup>
                <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
                  <div className="font-medium">Required: name, code</div>
                  <div className="text-muted-foreground">
                    Optional: base_unit, operator, operation_value
                  </div>
                </div>
