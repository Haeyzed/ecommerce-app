...
import { useProductsImport, useProductsTemplateDownload } from "../api"
import { productImportSchema, type ProductImportFormData } from "../schemas"
import { ProductsImportPreviewDialog } from "./products-import-preview-dialog"
...
export function ProductsImportDialog({
  ...
  const { mutate: importProducts, isPending } = useProductsImport()
  const { mutate: downloadTemplate, isPending: isDownloading } =
    useProductsTemplateDownload()
  ...
  const form = useForm<ProductImportFormData>({
      ...
      <ResponsiveDialog open={open} onOpenChange={handleOpenChange}>
        <ResponsiveDialogContent className="sm:max-w-md">
          <ResponsiveDialogHeader className="text-start">
            ...
            <ResponsiveDialogDescription>
              Bulk create products by uploading a CSV file.
            </ResponsiveDialogDescription>
          </ResponsiveDialogHeader>
