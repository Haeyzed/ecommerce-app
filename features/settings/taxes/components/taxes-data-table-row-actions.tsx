...
interface TaxesDataTableRowActionsProps {
  row: Row<Tax>
}

export function TaxesDataTableRowActions({
  row,
}: TaxesDataTableRowActionsProps) {
  const { setOpen, setCurrentRow } = useTaxesContext()
