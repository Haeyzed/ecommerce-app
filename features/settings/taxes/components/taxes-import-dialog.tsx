...
import { TaxesImportPreviewDialog } from "./taxes-import-preview-dialog"

interface TaxesImportDialogProps {
  open: boolean
      ...
      <ResponsiveDialog open={open} onOpenChange={handleOpenChange}>
        <ResponsiveDialogContent className="sm:max-w-md">
          <ResponsiveDialogHeader className="text-start">
            <ResponsiveDialogTitle>Import Taxes</ResponsiveDialogTitle>
            <ResponsiveDialogDescription>
              Bulk create taxes by uploading a CSV file.
            </ResponsiveDialogDescription>
          </ResponsiveDialogHeader>
              ...
              <FieldGroup>
                <div className="space-y-2 rounded-md border bg-muted/50 p-3 text-sm">
                  ...
                  <div className="text-muted-foreground">
                    Optional: woocommerce_tax_id, is_active
                  </div>
                </div>
