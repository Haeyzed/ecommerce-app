...
import { TaxesDataTableBulkActions } from "./taxes-data-table-bulk-actions"
...
export function TaxesTable() {
  ...
  if (isLoading) {
    return (
      <div className="data-table-container">
        <DataTableSkeleton
          columnCount={taxesColumns.length}
          rowCount={10}
          filterCount={4}
          cellWidths={["2rem", "auto", "10rem", "14rem", "7rem", "7rem", "2rem"]}
        />
      </div>
    )
  }
  ...
  return (
    <div className="data-table-container flex flex-1 flex-col gap-4 max-sm:has-[div[role='toolbar']]:mb-16">
      <DataTable
        table={table}
        actionBar={<TaxesDataTableBulkActions table={table} />}
      >
