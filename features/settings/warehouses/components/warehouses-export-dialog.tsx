...
import { useWarehousesExport } from "../api"
import { DEFAULT_EXPORT_COLUMNS, WAREHOUSE_EXPORT_COLUMNS } from "../constants"
import { warehouseExportSchema, type WarehouseExportFormData } from "../schemas"

interface WarehousesExportDialogProps {
  open: boolean
    ...
    <ResponsiveDialog open={open} onOpenChange={handleOpenChange}>
      <ResponsiveDialogContent className="sm:max-w-2xl">
        <ResponsiveDialogHeader className="text-start">
          <ResponsiveDialogTitle>Export Warehouses</ResponsiveDialogTitle>
          <ResponsiveDialogDescription>
                ...
                render={({ field }) => (
                  <Field>
                    ...
                    <div className="grid grid-cols-2 gap-3 rounded-md border p-3">
                      {WAREHOUSE_EXPORT_COLUMNS.map((col) => (
                        <div
                          key={col.value}
