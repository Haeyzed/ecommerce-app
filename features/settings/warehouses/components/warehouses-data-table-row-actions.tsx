...
interface WarehousesDataTableRowActionsProps {
  row: Row<Warehouse>
}

export function WarehousesDataTableRowActions({
  row,
}: WarehousesDataTableRowActionsProps) {
  const { setOpen, setCurrentRow } = useWarehousesContext()
