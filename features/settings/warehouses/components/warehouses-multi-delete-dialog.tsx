...
import { useBulkDeleteWarehouses } from "../api"
import type { Warehouse } from "../types"

const CONFIRM_WORD = "DELETE"

interface WarehousesMultiDeleteDialogProps {
  open: boolean
...
export function WarehousesMultiDeleteDialog({
  ...
  const { mutate: bulkDestroy, isPending } = useBulkDeleteWarehouses()
    ...
    <ConfirmResponsiveDialog
      ...
      description={
        <div className="space-y-4">
          <p className="mb-2">
            Are you sure you want to delete the selected warehouses?
            <br />
