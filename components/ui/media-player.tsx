...
function MediaPlayerControls(props: DivProps) {
  ...
  return (
    <ControlsPrimitive
      ...
      dir={context.dir}
      className={cn(
        "dark pointer-events-none absolute start-0 end-0 bottom-0 z-50 flex items-center gap-2 px-4 py-3 opacity-0 transition-opacity duration-200 in-[:fullscreen]:px-6 in-[:fullscreen]:py-4 data-visible:pointer-events-auto data-visible:opacity-100",
        className
      )}
      {...controlsProps}
    />
