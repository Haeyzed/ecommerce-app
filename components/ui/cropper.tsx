...
const cropperAreaVariants = cva(
  "absolute start-1/2 top-1/2 box-border -translate-x-1/2 -translate-y-1/2 overflow-hidden border border-[2.5px] border-white/90 shadow-[0_0_0_9999em_rgba(0,0,0,0.5)] rtl:translate-x-1/2",
  {
    variants: {
      shape: {
        rectangle: "",
      ...
      withGrid: {
        true: "before:absolute before:start-1/3 before:end-1/3 before:top-0 before:bottom-0 before:box-border before:border before:border-t-0 before:border-b-0 before:border-white/50 before:content-[''] after:absolute after:start-0 after:end-0 after:top-1/3 after:bottom-1/3 after:box-border after:border after:border-s-0 after:border-e-0 after:border-white/50 after:content-['']",
        false: "",
      },
    },
    defaultVariants: {
